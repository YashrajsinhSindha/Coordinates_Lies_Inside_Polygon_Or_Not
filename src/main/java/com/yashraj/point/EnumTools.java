...
//     -Added "AliasList" interface (allow alias-name list when looking up via String name)
// ----------------------------------------------------------------------------
...
public class EnumTools
{
    ...
    *** @return The default enum constant of the specified enum type.
    **/
    public static Enum<?> _getDefault(Class<? extends Enum<?>> enumClass)
    {
    ...
    **/
    public static <T extends Enum<T>> T getValueOf(Class<T> enumClass, String name, boolean rtnDefault)
    {
        return EnumTools.getValueOf(enumClass, name, null, null, rtnDefault);
    }
    ...
    protected static <T extends Enum<T>> T getValueOf(Class<T> enumClass, String name, Locale loc, T dft, boolean rtnDefault)
    {
        if ((enumClass != null) && (name != null)) {
            ...
            if ((e != null) && (e.length > 0)) {
                ...
                int  nameIntVal  = StringTools.parseInt( name,Integer.MIN_VALUE);
                long nameLongVal = StringTools.parseLong(name,Long.MIN_VALUE);
                for (int n = 0; n < e.length; n++) {
                    ...
                    if ((e[n] instanceof IntValue) && (((IntValue)e[n]).getIntValue() == nameIntVal)) {
                        return e[n];
                    } else
                    if ((e[n] instanceof LongValue) && (((LongValue)e[n]).getLongValue() == nameLongVal)) {
                        return e[n];
                    } else 
                    if ((e[n] instanceof AliasList) && ListTools.containsIgnoreCase(((AliasList)e[n]).getAliasList(),name)) {
                        return e[n];
                    }
                }
    ...
    *** @return The enum constant of the specified enum type with the specified name or 'toString()' value
    **/
    public static Enum<?> _getValueOf(Class<? extends Enum<?>> enumClass, String name, Locale loc, Enum<?> dft, boolean rtnDefault)
    {
        if ((enumClass != null) && enumClass.isEnum() && (name != null)) {
            ...
            if ((e != null) && (e.length > 0)) {
                ...
                if (rtnDefault && (dft == null)) {
                    // -- return the default constant
                    return EnumTools._getDefault(enumClass);
                } else {
                    return dft;
                }
    ...
    *** @return The enum constant of the specified enum type with the specified integer value
    **/
    public static Enum<?> _getValueOf(Class<? extends Enum<?>> enumClass, int value, Enum<?> dft, boolean rtnDefault)
    {
        if (enumClass != null) {
    ...
    **/
    public static <T extends Enum<?>> void registerEnumClass(String name, Class<T> enumClass)
    {
        if ((enumClass != null) && enumClass.isEnum()) {
            ...
            /* init registry */
            if (EnumTools.enumRegistry == null) {
                EnumTools.enumRegistry = new HashMap<String,Class<? extends Enum<?>>>();
            }
            ...
            /* save */
            if (EnumTools.enumRegistry.containsKey(name)) {
                Class<? extends Enum<?>> eclz = EnumTools.enumRegistry.get(name);
                ...
                EnumTools.enumRegistry.put(name,enumClass);
            }
    ...
    **/
    ...
    {
        if ((EnumTools.enumRegistry != null) && (name != null)) {
            ...
            if (enumContainerClass != null) {
                ...
                if (EnumTools.enumRegistry.containsKey(n)) {
                    return EnumTools.enumRegistry.get(n);
                }
            }
            // then try name "EnumType"
            if (EnumTools.enumRegistry.containsKey(name)) {
                return EnumTools.enumRegistry.get(name);
            }
        }
        return null;
    }
