    ...
    implements Comparable<RTKey>
{
  ...
  //public static final String SESSION_NAME                 = "session.name";         // ie. (OBSOLETE) PrivateLabel name
    ...
    public static final String SESSION_PRIVLABEL            = "session.privateLabel"; // ie. "gpstracking"
    ...
    public static final String SMTP_SERVER_USER_NAME        = "smtp.user.fullName";
    public static final String SMTP_SERVER_PASSWORD         = "smtp.password";
    public static final String SMTP_AUTH_METHOD             = "smtp.authenticationMethod";  // [2.6.7-B46r]
    public static final String SMTP_OAUTH2_TOKEN_CLASS      = "smtp.oauth2.tokenClass";     // [2.6.7-B46n]
    public static final String SMTP_OAUTH2_PROVIDER_URL     = "smtp.oauth2.providerURL";    // [2.6.7-B46n]
    public static final String SMTP_OAUTH2_CLIENT_ID        = "smtp.oauth2.clientID";       // [2.6.7-B46n]
    public static final String SMTP_OAUTH2_SECRET           = "smtp.oauth2.secret";         // [2.6.7-B46n]
    public static final String SMTP_OAUTH2_REFRESH_TOKEN    = "smtp.oauth2.refreshToken";   // [2.6.7-B46n]
    public static final String SMTP_OAUTH2_ACCESS_TOKEN     = "smtp.oauth2.accessToken";    // [2.6.7-B46n]
    ...
    public static final String SMTP_FROM_EMAILADDRESS_      = "smtp.from.emailAddress."; // [2.6.6-B24h]
    public static final String SMTP_TO_EMAILADDRESS_        = "smtp.to.emailAddress.";   // [2.6.6-B24h]
  ...
  //public static final String DB_DEFAULT_RWMODE            = "db.defaultReadWriteMode";            // String
    ...
    public static final String DB_SHOW_SQL                  = "db.showSQL";                         // Boolean (debug)
    public static final String DB_SHOW_CONNECTIONS          = "db.showConnections";                 // Boolean (debug)
    ...
    // -- db record insert/update/delete listener
    public static final String _DB_RECORD_LISTENER          = ".recordListener";                    // String (Suffix)

    // -- db table audit
    public static final String DB_ENABLE_TABLE_AUDIT        = "db.enableTableAudit";                // Boolean
    public static final String _DB_TABLE_AUDIT              = ".auditTable";                        // Boolean (Suffix)
    ...
    public static final String ServerSocketThread_reOpenSocketOnUnexpectedClose = "ServerSocketThread.reOpenSocketOnUnexpectedClose"; // Boolean
    ...
    protected static Entry runtimeKeys[] = {
      ...
      //new Entry(SESSION_NAME               , null                             , "Session context name"),                      // WEB
        ...
        new Entry(SESSION_PRIVLABEL          , null                             , "Session PrivateLabel name"),                      // WEB
        ...
        new Entry(SMTP_SERVER_USER_NAME      , null                             , "SMTP User full name"),                       // APP|WEB
        new Entry(SMTP_SERVER_PASSWORD       , null                             , "SMTP server password"),                      // APP|WEB
        new Entry(SMTP_AUTH_METHOD           , null                             , "SMTP authentication method"),                // APP|WEB [2.6.7-B46r]
        new Entry(SMTP_OAUTH2_PROVIDER_URL   , null                             , "SMTP OAUTH2 Provider URL"),                   // APP|WEB [2.6.7-B46n]
        new Entry(SMTP_OAUTH2_CLIENT_ID      , null                             , "SMTP OAUTH2 Client-ID"),                      // APP|WEB [2.6.7-B46n]
        new Entry(SMTP_OAUTH2_SECRET         , null                             , "SMTP OAUTH2 Secret"),                         // APP|WEB [2.6.7-B46n]
        new Entry(SMTP_OAUTH2_REFRESH_TOKEN  , null                             , "SMTP OAUTH2 Refresh-Token"),                  // APP|WEB [2.6.7-B46n]
        new Entry(SMTP_OAUTH2_ACCESS_TOKEN   , null                             , "SMTP OAUTH2 Access-Token"),                   // APP|WEB [2.6.7-B46n]
        ...
        new Entry(SMTP_THREAD_MODEL          , null                             , "Send-Mail thread model"),                    // APP|WEB
        new Entry(SMTP_THREAD_MODEL_SHOW     , false                            , "Print/show Send-Mail thread model"),         // APP|WEB
        new Entry(SMTP_IGNORED_EMAIL_FILE    , null                             , "File containing ignored email addresses"),   // APP|WEB
        new Entry(SMTP_FROM_EMAILADDRESS_    , null                             , "SMTP 'From' address (keyed)"),               // APP|WEB
        new Entry(SMTP_TO_EMAILADDRESS_      , null                             , "SMTP 'To' address (keyed)"),                 // APP|WEB
      ...
      //new Entry(DB_DEFAULT_RWMODE          , "READ_WRITE"                     , "Default DB Read/Write Mode"),                // APP|WEB
