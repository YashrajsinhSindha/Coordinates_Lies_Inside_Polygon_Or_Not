...
//  2018/08/12  Martin D. Flynn
//     -Added "size(Object)", "isEmpty(Object)"
//     -Modified "isContainer(Object)"
//  2020/02/19  GTS Development Team
//     -Added "reverseOrder(byte list[])"
// ----------------------------------------------------------------------------
...
public class ListTools
{
    ...
    **/
    ...
    /**
    *** Returns the size of the specified non-descript Object container
    *** @param obj  The Object container
    *** @return The size of the specified Object container, or zero if the Object is not a container
    **/
    public static int size(Object obj)
    {
        ...
        if (obj instanceof Class) {
            Object e[] = ((Class)obj).getEnumConstants(); // Enum
            return ((e != null) && (e.length > 0))? e.length : 0;
        } else
    ...
    **/
    ...
    /**
    *** Returns true if the specified container object is empty
    *** @param obj  The container object instance
    *** @return True if the specified container object is null/empty
    **/
    public static boolean isEmpty(Object obj)
    {
        ...
        if (obj instanceof Iterable) { // List/Collection/Set
            return ((Iterable)obj).iterator().hasNext()? false : true;
        } else
        if (obj instanceof Iterator) {
            return ((Iterator)obj).hasNext()? false : true;
        } else
        if (obj instanceof Enumeration) {
            return ((Enumeration)obj).hasMoreElements()? false : true;
        } else
        if (obj instanceof Class) {
            Object e[] = ((Class)obj).getEnumConstants(); // Enum
    ...
    **/
    public static boolean isContainer(Object obj)
    {
        ...
        if (obj instanceof Class) {
            Object e[] = ((Class)obj).getEnumConstants(); // Enum
            return ((e != null) || (e.length > 0))? true : false;
        } else
        if (obj.getClass().isArray()) {
            return true;
        } else {
    ...
    *** @param a1  First boolean array
    *** @param a2  Second boolean array
    *** @return True if the boolean arrays are equal
    **/
    public static boolean equals(boolean a1[], boolean a2[])
    {
        return (ListTools.diff(a1,a2) < 0)? true : false;
    }
    ...
    **/
    ...
    /**
    *** Returns true if the specified arrays are equal
    *** @param a1  First char array
    *** @param a2  Second char array
    ...
    *** @param a1  First int array
    *** @param a2  Second int array
    *** @return True if the int arrays are equal
    **/
    ...
    *** @param a1  First long array
    *** @param a2  Second long array
    *** @return True if the long arrays are equal
    **/
    ...
    *** @param a1  First double array
    *** @param a2  Second double array
    *** @return True if the double arrays are equal
    **/
    ...
    **/
    public static <T> T[] initArray(T arry[], T val)
    {
        if (arry != null) {
    ...
    **/
    ...
    /**
    *** Initialize all elements of specified array [2.6.7-B20t]
    *** @param arry  The array
    *** @param val   The value used to initialize the elements in the array
    **/
    public static char[] initArray(char arry[], char val)
    {
        if (arry != null) {
            for (int i = 0; i < arry.length; i++) {
                arry[i] = val;
    ...
    **/
    ...
    /**
    *** Returns an AbstractList that is backed by the specified array
    *** @param a  The array
    *** @return The AbstractList wrapper
    **/
    ...
    *** @return The array with the element order reversed (in-place)
    **/
    public static byte[] reverseOrder(byte list[])
    {
        if ((list != null) && (list.length > 1)) {
            int len = list.length / 2;
            for (int i = 0; i < len; i++) {
    ...
    **/
    ...
    /**
    *** Creates a BigInteger seed from the specified String.
    *** Does not return null.
    *** Returns '0' if the String is null/empty.
    **/
    public static BigInteger createBigSeed(String val)
    {
        BigInteger dft = BigInteger.ZERO;
        if ((val == null) || val.equals("")) { // StringTools.isBlank(val)
            // -- blank/empty, return default
            return dft;
        } else
        if (val.equals("!")) { 
            // -- blank/empty, return default
        ...
        // --
        if (StringTools.isBigInteger(val,true/*strict*/)) {
            // -- parsable BigInteger
            BigInteger bi = StringTools.parseBigInteger(val,dft);
            return not? bi.not() : bi;
        } else {
            // -- convert to bytes
            try {
                BigInteger bi = new BigInteger(1,val.getBytes());
                return not? bi.not() : bi;
            } catch (NumberFormatException nfe) {
                return not? dft.not() : dft;  // (will not occur)
            }
        }
    }
    ...
    **/
    public static <T> T[] shuffle(T list[], BigInteger bigSeed)
    {
        if ((list != null) && (bigSeed != null)) {
            ...
            while (bigSeed.bitLength() > 0) { // was (bigSeed.compareTo(BigInteger.ZERO) != 0) ==> infinite loop
