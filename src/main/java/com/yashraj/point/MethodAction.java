    ...
    implements ActionListener, Runnable
{
    ...
    **/
    ...
    /**
    *** Returns true if the specified class method exists 
    **/
    public static boolean hasMethod(Class<?> targetClass, String methName, Class<?>... argType)
    {
    ...
    **/
    ...
    /**
    *** Returns true if the specified static class method exists 
    **/
    public static boolean hasStaticMethod(Class<?> targetClass, String methName, Class<?>... argType)
    {
        Method meth = MethodAction.getStaticMethod(targetClass, methName, argType);
        return (meth != null)? true : false;
    }
    ...
    **/
    ...
    /**
    *** Returns true if the specified public static class method exists 
    **/
    public static boolean hasPublicStaticMethod(Class<?> targetClass, String methName, Class<?>... argType)
    {
        Method meth = MethodAction.getPublicStaticMethod(targetClass, methName, argType);
        return (meth != null)? true : false;
    }
    ...
    *** Returns true if the specified public static class method exists 
    **/
    public static boolean hasPublicInstanceMethod(Class<?> targetClass, String methName, Class<?>... argType)
    {
        Method meth = MethodAction.getPublicInstanceMethod(targetClass, methName, argType);
        return (meth != null)? true : false;
    }
    ...
    **/
    ...
    /**
    *** Calls the "setAccessible(...)" method on the specified AccessibleObject.
    *** @param accessible True to suppress Java language access checking, false otherwise.
    *** @return True if the call was successful, false if an exception/error occurred
    **/
