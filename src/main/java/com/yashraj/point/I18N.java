    ...
    **/
    public static class Text
    {
        ...
        public boolean hasDefaultParameters() {
            if (this.hasDefault()) {
                int s = 0;
                for (;(s >= 0) && (s < this.dft.length());) {
                    int p = this.dft.indexOf("{",s);
                    if ((p < 0) || ((p+1) >= this.dft.length())) {
                        break;
                    }
                    if (Character.isDigit(this.dft.charAt(p+1))) {
                        return true;
                    }
                    s = p + 1;
                }
        ...
        //    return this._toString(i18n, dftVal, null);
        //}
        public String toString(I18N i18n) {
            return this._toString(i18n, this.dft, null);
        }
        public String toString(I18N i18n, String... args) {
            return this._toString(i18n, this.dft, args);
        }
        private String _toString(I18N i18n, String dftVal, Object args[]) {
        ...
        //    return this._toString(loc, dftVal, null);
        //}
        public String toString(Locale loc) {
            return this._toString(loc, this.dft, null);
        }
        public String toString(Locale loc, String... args) {
            return this._toString(loc, null, args);
        }
        private String _toString(Locale loc, String dftVal, String args[]) {
            String dv = (dftVal != null)? dftVal : this.dft;
            if ((loc != null) && (this.pkg != null)) {
                return this._toString(I18N.getI18N(this.pkg,loc), dv, args);
            } else {
                return I18N.decodeNewLine(dv);
            }
        }
