    ...
    implements Cloneable, GeoPointProvider
{
    ...
    **/
    ...
    public  static final double PI                              = Math.PI;  // 3.14159265
    ...
    **/
    ...
    /**
    *** Returns a GeoPoint from the specified GeoPointProvider
    *** @param gpp The GeoPointProvider
    *** @param dft The default GeoPoint
    *** @return The GeoPoint
    **/
    public static GeoPoint getGeoPoint(GeoPointProvider gpp, GeoPoint dft)
    {
        if (gpp == null) {
            return dft;
        } else
    ...
    /**
    *** Returns a non-null GeoPoint from the specified GeoPointProvider
    *** @param gpp The GeoPointProvider
    *** @return The GeoPoint (does not return null)
    **/
    public static GeoPoint getGeoPoint(GeoPointProvider gpp)
    {
        return GeoPoint.getGeoPoint(gpp, GeoPoint.INVALID_GEOPOINT);
    }
