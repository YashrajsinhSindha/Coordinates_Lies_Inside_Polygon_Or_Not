...
//     -Added [get|set]ByteArray_* methods [2.6.6-B03]
//     -Updated "getStringArray" to also parse/return existing array objects.
//  2020/02/19  GTS Development Team
//     -Added DateTime property methods (see "getDateTime") [2.6.7-B21b]
// ----------------------------------------------------------------------------
    ...
    RTConfig.PropertySetter, RTConfig.PropertyGetter
{
  ...
  //public  static final char    NameSeparatorChar          = ':';
    ...
    *** Adds the properties from the specified input stream to this instance
    *** @param in  The input stream from which properties will be loaded to this instance
    *** @param inclName  True to set the name of this instance to the name found in the InputStream
    ...
    **/
    ...
    /**
    *** Removes all specified property keys from this instance
    ...
    **/
    ...
    /**
    *** Key/Value Replacement map
    **/
    private static class KeyValueReplacementMap
        implements StringTools.KeyValueMap
    {
        ...
        private RTProperties rtp        = null;
        public KeyValueReplacementMap(Object mainKey, RTProperties rtp) {
            if (mainKey != null) { 
                this.fullKeySet.add(mainKey);
            }
            this.rtp = rtp;
        }
        public void resetCachedKeys() {
        ...
        public String getKeyValue(String k, String argNotUsed, String dft) {
            ...
            if (this.fullKeySet.contains(key)) {
                // -- prevent infinite recursive replacement
                //Print.logError("Key already processed: " + key);
                return null;
            } else {
                // -- mark this key as used and get value
        ...
        public String getString(String key, String dft) {
            if (this.rtp != null) {
                Object obj = this.rtp._getProperty(key, null);
                if (obj != null) {
                    return obj.toString();
                }
            }
    ...
    **/
    public static String _insertKeyValues(
        Object mainKey, RTProperties rtp,
        String text, 
        String startDelim, String endDelim, String dftDelim)
    {
        return RTProperties._insertKeyValues(
            mainKey, new KeyValueReplacementMap(mainKey, rtp),
            text,
    ...
    *** @see StringTools#insertKeyValues
    **/
    public static String _insertKeyValues( // _insertKeyValues_main
        Object mainKey, KeyValueReplacementMap kvrm,
        String text, 
        String startDelim, String endDelim, String dftDelim)
    {
        if ((text != null) && (kvrm != null)) {
            ...
            for (int i = 0; i < RTProperties.KEY_MAX_RECURSION; i++) {
                //Print.logInfo(i + "] Text: " + s_old);
                kvrm.resetCachedKeys(); // reset the cached keys for new interation
                String s_new = StringTools.insertKeyValues(s_old, 
                    startDelim, endDelim, dftDelim,
                    kvrm, false/*htmlFilter*/);
            ...
            // -- beyond max recursions
            return s_old;
        } else {
            return text; // returns text as-is
        }
    }
    ...
    **/
    public String insertKeyValues(String text)   
    {
        return RTProperties._insertKeyValues(
            null, this,
            text, 
            KEY_START_DELIMITER, KEY_END_DELIMITER, KEY_DFT_DELIMITER);
    }
    ...
    **/
        ...
        String startDelim, String endDelim)
    {
        return RTProperties._insertKeyValues(
            null, this,
            text, 
            startDelim, endDelim, KEY_DFT_DELIMITER);
    }
    ...
    *** @see StringTools#insertKeyValues
    **/
    public String _insertKeyValues(
        Object mainKey, 
        String text, 
        String startDelim, String endDelim, String dftDelim)
    {
    ...
    **/
    public String[] getStringArray(String key, String dft[])
    {
        ...
        if (val instanceof String) {
            String va[] = StringTools.parseArray((String)val);
            // -- TODO: check for RTKey.NULL_VALUE in string array
            return va;
        } else
        if (val.getClass().isArray()) {
            String va[] = new String[Array.getLength(val)];
            for (int i = 0; i < va.length; i++) {
                Object v = Array.get(val, i);
                va[i] = (v != null)? v.toString() : null;
            }
            return va;
        } else {
            String va[] = StringTools.parseArray(val.toString());
            // -- TODO: check for RTKey.NULL_VALUE in string array
            return va;
        }
    }
    ...
    **/
    ...
    /**
    *** Gets a <code>DateTime</code> property at the specified key
    *** @param key The key of the property
    *** @return The <code>DateTime</code> value of the property
    **/
    public DateTime getDateTime(String key)
    {
        return this.getDateTime(key, null);
    }

    /**
    *** Gets a <code>DateTime</code> property at the specified key.
    *** If the property value timezone is not specified, the default ('dft') timezone 
    *** will be used if available, otherwise GMT will be used.
    *** If the time-of-day is not specified, the start-of-day will be used.
    *** @param key The key of the property
    *** @param dft The default value to return if an entry was not found
    *** @return The <code>DateTime</code> value of the property
    **/
    public DateTime getDateTime(String key, DateTime dft)
    {
        Object val = this._getProperty(key, null/*dft*/, null/*dftClass*/, true/*replaceKeys*/);
        if (val == null) {
            return dft;
        ...
        if (val instanceof DateTime) {
            ...
            String   valStr   = val.toString(); // String|Long
            TimeZone dftTMZ   = (dft != null)? dft.getTimeZone() : DateTime.GMT;
            boolean  isToDate = false; // default to start-of-day
            try {
                return DateTime.parseArgumentDate(valStr, dftTMZ, isToDate);
            } catch (DateTime.DateParseException dpe) {
                Print.logDebug("Invalid DateTime format: " + valStr);
                return dft;
            }
        }
    }
    ...
    /**
    *** Sets the value of the specified property to the specified <code>DateTime</code>
    *** @param key The key of the property
    *** @param value The value to set the property to
    **/
    ...
    /**
    *** Gets a hex-value property as a <code>byte[]</code> at the specified key
    *** @param key The key of the property
    *** @return The <code>byte[]</code> value of the property
    **/
    public byte[] getByteArray_Hex(String key)
    {
        return this.getByteArray_Hex(key, null);
    }
    ...
    *** @return The <code>byte[]</code> value of the property
    **/
    public byte[] getByteArray_Hex(String key, byte dft[])
    {
        Object val = this._getProperty(key, null/*dft*/, null/*dftClass*/, true/*replaceKeys*/);
        if (val == null) {
            return dft;
        ...
        if (val instanceof byte[]) {
            ...
            return StringTools.parseHex(val.toString(),dft);
        }
    }

    /**
    *** Sets the value of the specified property to the specified <code>byte[]</code>
    *** @param key The key of the property
    *** @param value The value to set the property to
    **/
    public void setByteArray_Hex(String key, byte value[])
    {
        String hex = StringTools.toHexString(value);
        if (!StringTools.isBlank(hex)) {
            this.setProperty(key, "0x"+hex);
        } else {
    ...
    /**
    *** Gets a Base64-value property as a <code>byte[]</code> at the specified key
    *** @param key The key of the property
    *** @return The <code>byte[]</code> value of the property
    **/
    public byte[] getByteArray_Base64(String key)
    {
        return this.getByteArray_Base64(key, null);
    }
    ...
    *** @return The <code>byte[]</code> value of the property
    **/
    public byte[] getByteArray_Base64(String key, byte dft[])
    {
        Object val = this._getProperty(key, null/*dft*/, null/*dftClass*/, true/*replaceKeys*/);
        if (val == null) {
            return dft;
    ...
    *** @param value The value to set the property to
    **/
    public void setByteArray_Base64(String key, byte value[])
    {
        String b64 = Base64.encode(value);
        if (!StringTools.isBlank(b64)) {
            this.setProperty(key, b64);
        } else {
            this.setProperty(key, "");
        }
    }
    ...
    **/
    ...
    {
        return this.toString(null, null, null, (char)0, (char)0);
    }
    ...
    *** @return A string reperesentation of this <code>RTProperties</code>
    **/
    public String toString(char propSepChar)
    {
        return this.toString(null, null, null, (char)0, propSepChar);
    }
    ...
    **/
    ...
    {
        return this.toString(exclProps, null, null, (char)0, (char)0);
    }
    ...
    **/
    ...
    {
        return this.toString(null, orderBy, null, (char)0, (char)0);
    }
    ...
    **/
    ...
    {
        return this.toString(exclProps, orderBy, null, (char)0, (char)0);
    }
    ...
    **/
    ...
    {
        return this.toString(exclProps, orderBy, newLinePrefix, (char)0, (char)0);
    }
    ...
    *** @param newLinePrefix A string to prefix new property lines with, for 
    ***        example, some spaces for indentation
    *** @param kvSepChar The key/value separator character
    *** @param propSepChar The property separator character
    *** @return A string reperesentation of this <code>RTProperties</code>
    **/
    public String toString(RTProperties exclProps, Collection<?> orderBy, String newLinePrefix, 
        char kvSepChar, char propSepChar)
    {
        StringBuffer sb = new StringBuffer();
        boolean inclNewLine = (newLinePrefix != null);
        
        /* property separator character */
        char _propSepChar = (propSepChar != (char)0)? propSepChar : this.getPropertySeparatorChar();
        char _kvSepChar   = (kvSepChar   != (char)0)? kvSepChar   : this.getKeyValueSeparatorChar();
    ...
    private static final String KEY_LOG_STACKTRACE      = "%logStackTrace";   // 
        ...
        extends Properties
    {
        ...
        public String getString(String key, String dft) {
            ...
            if (this.orderedMap.containsKey(key)) {
                // -- local OrderedMap
                return StringTools.blankDefault(this.orderedMap.get(key),dft);
            } else
            if (this.containsKey(key)) {
                // -- local Properties
                return StringTools.blankDefault(this.get(key),dft);
            } else 
            if ((this.parentProps != null) && this.parentProps.containsKey(key)) {
                // -- parent 
                return this.parentProps.getString(key, dft);
            } else {
                // -- last chance default
        ...
        public boolean getBoolean(String key, boolean dft) {
            return StringTools.parseBoolean(this.getString(key,null),dft);
        }
        ...
        public Object put(Object key, Object value) {
            ...
            if (ks.startsWith(RTKey.CONSTANT_PREFIX)) { // %...
                    ...
                    if (this.recursionLevel >= MAX_INCLUDE_RECURSION) { 
                        ...
                        try {
                            ...
                            if (url != null) {
                                ...
                                OrderedProperties p = new OrderedProperties(this.recursionLevel + 1, url);
                                p.setParentProperties(this);
                                p.put(RTKey.CONFIG_URL, url.toString()); // save CONFIG_URL for internal referencing
                                p.loadProperties(p, uis, isXML);         // <-- fixed to properly reference "%configURL"
                                p.remove(RTKey.CONFIG_URL);              // remove CONFIG_URL before saving to parent properties
                                this.orderedMap.putAll(p.getOrderedMap());
                ...
                if (ks.equalsIgnoreCase(KEY_LOG) || ks.equalsIgnoreCase(KEY_LOG_STACKTRACE)) {
                    if (RTProperties.this.getConfigLogMessagesEnabled()) {
                        // -- not very efficient, but this doesn't need to be since config files are seldom loaded.
                        boolean stacktrace = ks.equalsIgnoreCase(KEY_LOG_STACKTRACE)? true : false;
                        StringBuffer sb = new StringBuffer();
                        ...
                        // --
                        if (stacktrace) {
                            Print._logStackTrace(Print.LOG_INFO, 0, sb.toString(), null);
                        } else {
                ...
                if (ks.equalsIgnoreCase(KEY_RTP)) {
                    try {
                        String R[] = (value instanceof String)? StringTools.split((String)value,':') : null;
                        int    RL  = ListTools.size(R);
                        String _RK = (RL >= 2)? R[0] : "";
                        String _RV = (RL >= 2)? R[1] : (RL == 1)? R[0] : "";
                        if (!StringTools.isBlank(_RV)) {
                            String RK = RTProperties._insertKeyValues(
                                null, 
                                new KeyValueReplacementMap(null,null) {
                                    public String getString(String key, String dft) {
                                        return OrderedProperties.this.getString(key,dft);
                                    }
                                },
                                StringTools.trim(_RK), // target String
                                KEY_START_DELIMITER, KEY_END_DELIMITER, KEY_DFT_DELIMITER);
                            byte RB[] = Base64.decode(_RV,ListTools.createBigSeed(RK)); // Base64.Base64DecodeException
                            if (StringTools.isPrintableASCII(RB)) {
                                ByteArrayInputStream bais = new ByteArrayInputStream(RB);
                                OrderedProperties p = new OrderedProperties(this.recursionLevel + 1, null);
                                p.setParentProperties(this);
                                p.loadProperties(p, bais, false); // IOException (unlikely)
                                this.orderedMap.putAll(p.getOrderedMap());
                                bais.close(); // not necessary
                            } else {
                                // -- invalid decode
                                Print.logError("Unable to decode '"+KEY_RTP+"'");
                            }
                        }
                    } catch (Base64.Base64DecodeException bde) { 
                        // -- invalid Base64
                        Print.logError("Unable to decode '"+KEY_RTP+"'");
                    } catch (Throwable th) { // NumberFormatException, IOException
                        // -- should not occur
                        Print.logError("Unable to decode '"+KEY_RTP+"'"); // unlikely
                    }
                    return "";
                } else
                if (ks.startsWith(KEY_IF) || ks.startsWith(KEY_ELSE) || ks.startsWith(KEY_ENDIF)) {
                    // -- these should be handled during the input-stream load process
                    Print.logError("'"+KEY_IF+".."+KEY_ENDIF+"' NOT SUPPORTED HERE !!!");
                    return "";
                } else
                /*
        ...
        public Properties loadProperties(Properties props, InputStream in, boolean isXML) throws IOException {
            ...
            if (isXML) {
                ...
                //   </properties>
                props.loadFromXML(in); // <Properties>.loadFromXML(...)
                return props;
            } else {
        ...
        public Properties loadProperties(Properties props, InputStream in) throws IOException {
            ...
            for (int i = 0; i < ds.length; i++) {
                ...
                if (d.startsWith(KEY_LOG) || d.startsWith(KEY_LOG_STACKTRACE)) {
                    //Print.logInfo("Parsing %log ...");
                    if (inclDef && RTProperties.this.getConfigLogMessagesEnabled()) {
                        // -- not very efficient, but this doesn't need to be since config files are seldom loaded.
                        boolean stacktrace = d.startsWith(KEY_LOG_STACKTRACE)? true : false;
                        String msg = stacktrace? 
                            d.substring(KEY_LOG_STACKTRACE.length()).trim() : 
                            d.substring(KEY_LOG.length()).trim();
    ...
    **/
    public static void main(String argv[])
    {
        ...
        /*  , 
            new String[] { // validateKeyAttributes
                "s:",
                "b,bb:m,b",
                "f,ff,fff:f",
                "d,dd,ddd,dddd:d",
