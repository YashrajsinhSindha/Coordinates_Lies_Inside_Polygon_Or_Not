...
//     -Removed method "sort(Comparator...)" due to conflict with Java-8
// ----------------------------------------------------------------------------
    ...
    implements Set<K>, java.util.List<K>, Cloneable
{
    ...
    **/
    ...
    /**
    *** Sorts the key set based on the specified Comparator. <br>
    *** NOTE: as of Java-8, the "java.util.List" interface now has it's own "sort(Comparator)"
    *** method, which caused a conflict with this method, causing an infinite recursion issue.
    *** As a result, this method has been removed to attempt to eliminate this issue (it does
    *** not appear to have been used anywhere anyway).
