    ...
    implements Map<K,V>
{
    ...
    **/
    public OrderedMap(Map<K,V> map) 
    {
        ...
        if (map instanceof OrderedMap) {
            OrderedMap om = (OrderedMap)map;
            this.setIgnoreCase(om.isIgnoreCase());
            if (om.orderedKeySet() != null) {
                boolean retainOriginalValue = om.orderedKeySet().getRetainOriginalValue();
                this.orderedKeySet().setRetainOriginalValue(retainOriginalValue);
            }
        }
        this.putAll(map);
    }
    ...
    *** @param map  A map from which all contents will be copied
    **/
    public OrderedMap(Map<K,V> map, boolean ignoreCase) 
    {
        this(map);
